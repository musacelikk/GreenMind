...
export default function IletisimPage() {
  ...
  const contactMethods = [
    ...
    },
    {
      id: 2,
      title: "E-posta",
      value: "info@greenmind.com",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
        </svg>
      ),
      link: "mailto:info@greenmind.com"
    },
    {
      id: 3,
      title: "Skyland İstanbul",
      value: "Huzur, Azerbaycan Cd. No:4, 34415 Sarıyer/İstanbul",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {contactMethods.map((method) => (
              <div
                key={method.id}
                className="relative rounded-xl bg-white/5 backdrop-blur-md border border-white/10 p-6 hover:bg-white/10 transition-all duration-300 group text-center"
              >
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">
                Bize Mesaj Gönderin
              </h2>

              {submitStatus === "success" && (
                <div className="mb-6 p-4 rounded-lg bg-green-500/20 border border-green-500/50 text-green-400 text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white placeholder-white/50 focus:outline-none focus:border-[#3ADC51] transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white placeholder-white/50 focus:outline-none focus:border-[#3ADC51] transition-colors resize-none"
                ...
                <div className="text-center">
                  <button
                    ...
                    className="px-8 py-3 rounded-lg bg-gradient-to-r from-[#6DA5FF] to-[#3ADC51] text-white font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
                  >
