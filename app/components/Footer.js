...
export default function Footer() {
  return (
    <footer className="relative w-full bg-black/80 backdrop-blur-md border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white/70 text-sm leading-relaxed max-w-md">
              Akıllı sulama sistemleri ile tarımınızı geleceğe taşıyın. 
              Toprak ve bitki verilerini analiz ederek en verimli sulama çözümlerini sunuyoruz.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-white/70 text-sm">info@greenmind.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-white mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-white/70 text-sm">+90 (555) 123 45 67</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-white mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-white/70 text-sm">Skyland İstanbul<br />Huzur, Azerbaycan Cd. No:4, 34415 Sarıyer/İstanbul</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between pt-8 border-t border-white/10">
          ...
          <div className="text-white/50 text-sm">
            © {new Date().getFullYear()} GreenMind. Tüm hakları saklıdır.
          </div>
        </div>
      </div>
    </footer>
